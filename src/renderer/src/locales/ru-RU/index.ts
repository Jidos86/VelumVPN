export default {
  ...
  velumUi: {
    ...
    server: {
      ...
      showMs: 'Показывать пинг в мс',
      check: 'Проверить пинг',
      pin: 'Закрепить в «Случайном сервере»',
      unpin: 'Открепить',
    ...
    rules: {
      ...
      invalid: 'Не подходит: {{item}}. Проверьте формат значения',
      invalidBulk: 'Пропущено записей с неверным форматом: {{count}}',
