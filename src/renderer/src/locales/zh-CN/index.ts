export default {
  ...
  guide: {
    ...
    insertLinkDesc:
      '手动导入：点击右侧粘贴按钮，填入订阅链接后点击“下一步”。深链导入：若已出现确认弹窗，可直接点击“下一步”。',
    validLinkRequired: '请先输入有效的 http/https 链接后再继续。',
    importProfileTitle: '导入订阅',
    importProfileDesc: '手动导入请点击“导入”；深链导入请先在弹窗中确认导入，然后点击“下一步”。',
    completeImportRequired: '请先完成订阅导入后再继续。',
    deepLinkImportTitle: '通过深链导入',
    deepLinkImportDesc: '已检测到深链导入确认弹窗。请先在弹窗中确认导入，然后点击“下一步”。',
