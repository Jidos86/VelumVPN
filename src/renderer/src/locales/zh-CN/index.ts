export default {
  ...
  guide: {
    ...
    profileImport: '订阅导入',
    profileImportDesc:
      'VelumVPN 支持多种订阅导入方式，在此输入订阅链接，点击导入即可导入您的订阅配置，如果您的订阅需要代理才能更新，请勾选"代理"再点击导入，当然这需要已经有一个可以正常使用的订阅才可以',
    localProfile: '本地订阅',
    ...
    tunSettings: '虚拟网卡设置',
    tunSettingsDesc:
      '这里可以更改虚拟网卡相关设置，VelumVPN 理论上已经完全解决权限问题，如果您的虚拟网卡仍然不可用，可以尝试重设防火墙（Windows）或手动授权内核（MacOS/Linux）后重启内核',
    dnsDesc:
  ...
  pages: {
    home: {
      ...
      connected: '已连接',
      disconnecting: '断开中...',
      trafficRemaining: '白名单流量剩余:',
      trafficRemainingHint: '这是您移动设备的流量',
      daysRemaining: '剩余天数:',
      expires: '到期:',
      group: '分组:',
      proxy: '代理:',
